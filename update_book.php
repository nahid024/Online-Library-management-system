                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
							...
							<li><a  ><i class="fa fa-edit"></i>update book<span class="fa fa-chevron-down"></span></a>
							</li>
                ...
                <div class="row" style="min-height:500px">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
						   ...
						   <form name="from1" action="update_book_connect.php" method="post" class="col-lg-6">
						...
						<tr>
						<td><input type="text" class="form-control" placeholder="quentity" name="quan" required=""></td>
						</tr>
						
						<tr>
						<td><input type="text" class="form-control" placeholder="price" name="pri" required=""></td>
						</tr>
