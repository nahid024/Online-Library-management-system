                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
							...
							<li><a href="" ><i class="fa fa-desktop"></i>display Issue books<span class="fa fa-chevron-down"></span></a>
            ...
            <div class="">
                ...
                <div class="row" style="min-height:500px">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>display issue bokks</h2>

                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
							<form name="form1" action="display_issue_books_connect.php" method="post">
							<input type="text" name="t1" class="form-control" placeholder="enter student id:">
							<input type="submit" name="submit1" class="btn btn-default submit" value="search issue book">
						...
						echo"<th>";echo "studenr name";echo"</th>";
