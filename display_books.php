                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-desktop"></i>display all books and search <span class="fa fa-chevron-down"></span></a>
                ...
                <div class="row" style="min-height:500px">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
							...
							<form name="form1" action="search_book_connect.php " method="post">
							...
							<form name="form1" action="search_book_connect_author.php" method="post">
