                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="display_books.php"><i class="fa fa-edit"></i>display all books and search<span class="fa fa-chevron-down"></span></a>

                            </li>
							</li>
                            <li><a href="add_books_info.php"><i class="fa fa-edit"></i>insert book  <span class="fa fa-chevron-down"></span></a>
            ...
            <div class="">
                ...
                <div class="row" style="min-height:500px">
                    <div class="col-md-12 col-sm-12 col-xs-12">
							...
							<form name="form1" action="" method="post">
								<table>
									<tr>
										...
										<td>
										<input type="submit" name="submit1" class="btn btn-default submit" value="search">
										</td>
									</tr>
								</table>
						...
						<tr>
						<td><input type="text" class="form-control" placeholder="studentid" name="sid" disabled></td>
						</tr>
						<tr>
						<td><input type="text" class="form-control" placeholder="studentname" name="sname" required></td>
						</tr>
						<tr>
						<td><input type="text" class="form-control" placeholder="studentcontruct" name="scon" required></td>
						</tr>
						<tr>
						<td><input type="text" class="form-control" placeholder="studentemail" name="semail" required></td>
						</tr>
						 <tr>
						 <td>
						...
						<tr>
						<td><input type="text" class="form-control" placeholder="studentusername" name="susername" disabled></td>
						</tr>
						<tr>
